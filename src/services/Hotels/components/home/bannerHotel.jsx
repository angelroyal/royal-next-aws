    ...
    <Swiper
      ...
      <SwiperSlide className="!w-1/2 max-lg:!w-full !bg-gry-30 !bg-white">
        <div className="w-full flex justify-center !bg-white">
          ...
          <Image src={excDiscountsMobile} width={332} height={235} className="sm:hidden w-full h-full  rounded-lg object-cover bg-gry-30 !bg-white" alt="Banner Exc Discounts mobile" />
        </div>
      </SwiperSlide>
      ...
      <SwiperSlide className="!w-[24%] max-lg:!w-1/2 max-sm:!w-full !bg-gry-30 !flex !justify-center !bg-white">
        <div className="relative w-full flex justify-center ">
          ...
          <div className="absolute top-[39px] left-[33px] max-xl:top-[32px] max-xl:left-[33px] max-sm:left-[26%] max-sm:top-[40px]">
            ...
            <h4 className="m-m w-9/12 text-[#BEE0EE] text-fs-22 text-left max-2xl:text-fs-18 max-xl:text-fs-16 max-lg:text-fsw-38 max-sm:text-fs-22" >{languageData.titleBanners.subtitleTourM}</h4>
          </div>
        </div>
      </SwiperSlide>
      {/*TWO CARD TEXT */}
      ...
      <SwiperSlide className="!w-[24%] max-lg:!w-1/2 max-sm:!w-full !bg-gry-30 !flex !justify-center !bg-white">
        <div className="w-full flex justify-center">
          <Image src={bannerTour} width={266} height={235} className="w-[99%] h-[90%] max-lg:w-[96%] max-sm:!w-[79%] rounded-lg " alt="Banner tour mes de feb" />
        </div>
      </SwiperSlide>
      {/* THREE CARD IMAGE HOTEL */}
