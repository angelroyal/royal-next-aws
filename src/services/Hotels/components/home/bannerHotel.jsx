...
export function BannerHomeKnowMore() {
  ...
  return (
    ...
    <div className="flex h-[466px] mb-10 mt-10 max-lg:flex-col max-lg:h-auto">
      <div className="flex flex-col justify-center w-[55%] p-12 bg-white rounded-l-lg max-lg:w-full max-lg:rounded-t-lg max-lg:rounded-b-none max-lg:items-center">
        <h2 className="m-b text-fs-32 mb-[20px] max-lg:text-fs-26 max-md:text-fs-20 max-sm:text-fs-16 max-sm:mb-2">{languageData.titleBanners.bannerHoteldecided.havenDecided}</h2>

        {/* FIX BOOSTRAP mb-5 - mb-[20px */}
        <div className="mb-[20px] w-11/12 max-sm:leading-3 max-lg:text-center">
      ...
      <div className="w-[45%] h-full relative max-lg:w-full max-lg:h-[26rem] max-lg:rounded-b-lg max-lg:rounded-t-none">
        ...
        <Image src={selfie} width={505} height={472} alt="selfie" className="absolute right-0 bottom-[0] z-50 w-full max-lg:h-[30rem] object-cover" />
      </div>
