    ...
    return (
        <div className='mt-4 p-6 border border-[#EBEBEB] rounded-md bg-white'>
            ...
            <div className='flex justify-between mb-[12.5px]'>
                <span className='text-fs-16 m-b'>{languageData.titlesFilterTour.filterResults}</span>
                <button className='text-bl-100 text-fs-12 m-s-b'>{languageData.titlesFilterTour.reset}</button>
            </div>
                ...
                {({ open }) => (
                    <>
                        <Disclosure.Button className="flex w-full justify-between rounded-lg py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                            <span className='m-s-b text-fs-14'>{languageData.titlesFilterTour.priceRange}</span>
                            <ChevronUpIcon
                        ...
                        <Disclosure.Panel className="pb-2 pt-2 text-sm text-gray-500">
                            ...
                            <div className='flex  justify-between'>
                                <div className='flex flex-col gap-2'>
                                    <span className='text-gry-100 m-m text-fs-10'>{languageData.titlesFilterTour.minimum}</span>
                                    <span className='text-gry-100 m-m text-fs-10'>$1500</span>
                                </div>

                                <div className='flex flex-col gap-2'>
                                    <span className='text-gry-100 m-m text-fs-10'>{languageData.titlesFilterTour.maximum}</span>
                            ...
                            <div class="relative mb-6 !text-bl-100">
                                <input id="range" type="range" class="w-full h-1 bg-gray-200 rounded-lg appearance-none cursor-pointer outline-none "></input>
                            </div>
                            {/*END RANGE */}
                            ...
                            <div className='flex justify-between gap-2'>
                                ...
                                <div className='flex flex-col'>                                   
                                    <span className='text-gry-100 m-m text-fs-10'>{languageData.SearchBox.tabTour.from}</span>
                                    <input
                                        type='number'
                                ...
                                <div className='flex flex-col'>
                                    <span className='text-gry-100 m-m text-fs-10'>{languageData.titlesFilterTour.to}</span>
                                    <input
                                        type='number'
                                        className='w-[132px] border border-gry-70 rounded m-m text-fs-12 text-black py-[6px] px-[16px]'
            ...
            <Disclosure defaultOpen={isOpen}>
                {({ open }) => (
                    <>
                        <Disclosure.Button className="flex w-full justify-between rounded-lg py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                            <span className='m-s-b text-fs-14'>{languageData.titlesFilterHotel.Star}</span>
                            <ChevronUpIcon
                                className={`${open ? 'rotate-180 transform' : ''
                                    } h-5 w-5`}
                            />
                            ...
                            <div className='flex gap-7'>
                                <div className='flex flex-col gap-[8px]'>
                                    ...
                                    <div className='flex gap-2'>
                                        <input id='all-stars-a' type='checkbox' className="w-[20px] h-[20px]" />
                                        <label for="all-stars-a" className='m-m text-fs-12 cursor-pointer text-black'>{languageData.optionsFilterTour.allCategories}</label>
                                    </div>

                                    <div className='flex gap-2'>
                                        <input type='checkbox' id='five-stars' className="w-[20px] h-[20px]" />
                                    ...
                                    <div className='flex gap-2'>
                                        <input type='checkbox' id='four-stars' className="w-[20px] h-[20px]" />
                                ...
                                <div className='flex flex-col gap-[4px]'>
                                    <div className='flex gap-2 mb-1'>
                                        <input type='checkbox' id="three-stars" className="w-[20px] h-[20px]" />
                                    ...
                                    <div className='flex gap-2 mb-1'>
                                        <input type='checkbox' id='two-stars' className="w-[20px] h-[20px]" />
                                    ...
                                    <div className='flex gap-2'>
                                        <input type='checkbox' id='one-star' className="w-[20px] h-[20px]" />
            ...
            <Disclosure defaultOpen={isOpen}>
                {({ open }) => (
                    <>
                        <Disclosure.Button className="flex w-full justify-between rounded-lg py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                            <span className='m-s-b text-fs-14'>{languageData.titlesFilterHotel.titleTypeHotel}</span>
                                ...
                                {({ open }) => (
                                    <>
                                        ...
                                        <Disclosure.Button className="flex w-full py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                                            <span className='text-bl-100 text-fs-12 m-b underline'>{languageData.modalHotelOptions.buttonShowMore}</span>
                                            <ChevronUpIcon
                                                className={`${open ? 'rotate-360 transform' : 'rotate-180 transform'
                                                    } h-5 w-5 text-bl-100`}
                                            />
                                        </Disclosure.Button>
                                    </>
            ...
            <Disclosure defaultOpen={isOpen}>
                {({ open }) => (
                    <>
                        <Disclosure.Button className="flex w-full justify-between rounded-lg py-2 text-left text-sm font-medium focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75">
                            <span className='m-s-b text-fs-14'>{languageData.titlesFilterHotel.titleFood}</span>
                            <ChevronUpIcon
                                className={`${open ? 'rotate-180 transform' : ''
                                    } h-5 w-5`}
                            />
