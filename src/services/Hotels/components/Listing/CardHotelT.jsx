        ...
        <div className='flex border border-gry-50 rounded-lg mb-[10px] bg-white w-full gap-2 my-[20px] max-md:flex-col'>
            ...
            <div className='w-[70%] p-[20px] max-md:w-full'>
                ...
                <div className='flex max-md:flex-col'>
                    ...
                    {/* INFO PRICE */}
                    <div className='w-2/5 border-l border-gry-70 flex flex-col pl-[23px] items-center max-md:w-full max-md:border-t max-md:border-l-0 max-md:mt-2 max-md:pt-2 max-md:flex-row max-md:justify-between max-md:pl-0'>
                        <div className='flex flex-col items-center '>
                            ...
                            <div className='m-b bg-[#E0FEF0] text-grn-100 text-fs-8 mb-3 py-[4px] px-[8px] rounded'>{languageData.cartTour.taxesText}</div>
                        </div>
