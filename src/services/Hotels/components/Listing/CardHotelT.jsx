...
export default function CardHotelT() {
    ...
    return (
        ...
        <div className='max-sm:px-4'>
            <div className='flex border border-gry-50 rounded-lg mb-[10px] bg-white w-full gap-2 my-[20px] max-lg:flex-col '>
                ...
                <div className='w-[30%] relative max-lg:w-full max-lg:h-[225px]'>
                    ...
                    <Image
                        ...
                        height={91}
                    />
                    <div className='h-[13%] bg-black text-white m-b text-fs-12 flex items-center justify-center rounded-bl-lg max-lg:rounded-none'>{languageData.optionsFilterHotel.allInclusive}</div>
                </div>
                ...
                <div className='w-[70%] p-[20px] max-lg:w-full'>
                    ...
                    <div className='flex max-lg:flex-col'>
                        ...
                        {/* INFO HOTEL*/}
                        <div className='w-3/5  pr-[23px] max-lg:w-full flex flex-col gap-[8px]'>
                        ...
                        {/* INFO PRICE */}
                        <div className='w-2/5 border-l border-gry-[#ebebeb] flex flex-col pl-[23px] items-center justify-end max-lg:w-full max-lg:border-t max-lg:border-l-0 max-lg:mt-2 max-lg:pt-2 max-lg:flex-row max-lg:justify-between max-lg:pl-0'>
                            <div className='flex flex-col items-center '>
                                <span className='m-b text-red-100 text-fs-12'>¡{languageData.cardHotel.titleSpace} 3!</span>
                                <h2 className='m-b text-fs-16 flex items-center gap-1 text-nowrap'><span className='m-s-b text-fs-12'>{languageData.cartTour.from} </span>MXN $10,000</h2>
                            ...
                            <button className='bg-yw-100 text-black text-fs-12 m-b px-[40px] py-[5px] rounded-full hover:bg-yw-50 text-nowrap w-[136px] h-[32px]'>{languageData.cartTour.seeDetails}</button>
                        </div>
                    </div>
                </div>
            </div>
