...
export default function InfoModalTransport() {
  return (
    <div className='py-[48px] pl-[48px] flex flex-col gap-2'>
      {/* TITLE */}
      <h3 className='text-fs-24 m-b'>Reservar transporte</h3>

      {/* TYPE OF TRIP */}
      <span className='text-gry-100 text-fs-12 m-s-b'>Tipo de viaje</span>

      {/* FROM , TO */}
      <div className='text-gry-100 text-fs-12 m-s-b py-[8px] px-[16px] bg-gry-50 rounded-full'>Redondo</div>

      <span className='text-gry-100 text-fs-12 m-s-b'>Desde</span>

      <div className="flex bg-[#f1f6ff] rounded-[4px] gap-[8px] py-[10px] pl-[16px] w-[324px]">
        <img
      ...
      <div className='flex flex-col'>
        ...
        <div className='flex gap-[8px]'>
          ...
          <div className='px-[16px] py-[8px] border border-gry-50 '>
            2
          </div>
        ...
        <div className='flex gap-1 items-center'>
          <span className='text-fs-10 m-m'>Precio individual: </span>
          <span className='text-fs-10 m-b text-bl-100'>MXN</span>
