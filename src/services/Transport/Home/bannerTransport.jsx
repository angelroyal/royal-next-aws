            ...
            <SwiperSlide className="!w-[47%] max-lg:!w-full max-sm:!w-full !bg-gry-30 !rounded-lg">
                <div className="flex bg-white justify-center items-center shadow-3xl">
                    <div className="w-[40%] flex flex-col pl-[25px] gap-3 max-sm:!w-[58%]">
                        ...
                        <bottom className="px-[24px] py-[16px] bg-yw-100 hover:bg-yw-110 m-s-b text-fs-14 w-fit rounded-full text-nowrap">{languageData.bannerTransport.bookNowBtn}</bottom>
                    </div>
            ...
            <SwiperSlide className="!w-1/4 max-lg:!w-1/2 max-sm:!w-full !bg-gry-30 !flex !justify-center !bg-white">
                <div className="w-full flex justify-center">
                    ...
                    <div className="absolute bottom-[30px] left-[33px] max-xl:top-[32px] max-xl:left-[33px] max-sm:left-[12%] max-sm:top-[40px]">
                        <h2 className="m-b w-9/12 text-white text-fs-44 mb-5 text-left max-2xl:text-fs-22 max-xl:text-fs-18 max-lg:text-fsw-48 max-sm:text-fs-24">{languageData.bannerTransport.firstTime}</h2>
                        <div className="bg-red-100 rounded-full flex w-fit">
                            <span className="m-s-b text-white pl-[10px] py-[10px]">{languageData.bannerTransport.getOff}</span>
                            <span className="m-s-b text-black p-[10px] bg-white rounded-lg ml-[10px]">{languageData.titleBanners.bannerHoteldecided.knowMore}</span>
                        </div>
                    </div>
                </div>
            </SwiperSlide>
        ...
        <div className="flex gap-[16px]">
            ...
            <div className=" flex justify-center w-3/12 relative">
                ...
                <div className="absolute bottom-[30px] left-[33px] max-xl:top-[32px] max-xl:left-[2px] max-sm:left-[12%] max-sm:top-[40px]">
                    <h2 className="m-b w-9/12 text-white text-fs-44 mb-5 text-left max-2xl:text-fs-30">{languageData.bannerTransport.firstTime}</h2>
                    <div className="bg-red-100 rounded-full flex w-fit">
                        <span className="m-s-b text-white pl-[10px] py-[10px] text-nowrap max-xl:text-fs-12">{languageData.bannerTransport.getOff}</span>
                        <span className="m-s-b text-black p-[10px] bg-white rounded-lg ml-[10px] text-nowrap max-xl:text-fs-12 cursor-pointer hover:bg-gry-30">{languageData.titleBanners.bannerHoteldecided.knowMore}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <div className="bg-gry-30 rounded-lg flex gap-[16px] max-lg:flex-col my-32">
            ...
            <div className="flex flex-col gap-4 pl-[56px] py-[80px] pr-[25px] items-start justify-center max-md:py-[24px] max-md:pl-[16px] max-md:pr-[36px]">
                <h3 className="text-fs-36 m-b w-[75%] max-md:text-fs-26 max-lg:w-full">{languageData.bannerTransport.titleTravelSafely}</h3>
                <span className="m-m text-fs-16">{languageData.bannerTransport.ourDrivers}</span>
                <button className="px-[16px] py-[16px] rounded-full bg-yw-100 text-fs-14 m-s-b hover:bg-yw-110">{languageData.bannerTransport.bookTransferBtn}</button>
            </div>
        </div>
    )
}
