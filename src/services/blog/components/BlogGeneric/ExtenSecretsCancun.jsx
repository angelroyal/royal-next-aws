...
export default function ExtenSecretsCancun() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <TitleH1>{languageData.ExtenSecretsCancun.Section1.mainTitle}</TitleH1>

      <SubtitleP>
        {languageData.ExtenSecretsCancun.Section1.subtitle1.Text1}
        <BT>{languageData.ExtenSecretsCancun.Section1.subtitle1.BT}</BT>
        {languageData.ExtenSecretsCancun.Section1.subtitle1.Text2}
      </SubtitleP>

      {/* IMAGE 1 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun1.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section2.subtitle2.BT}</BT>
        {languageData.ExtenSecretsCancun.Section2.subtitle2.text2}
      </SubtitleP>

      <SubtitleP>
        {languageData.ExtenSecretsCancun.Section2.subtitle2.text3}
        <BT>{languageData.ExtenSecretsCancun.Section2.subtitle2.BT2}</BT>
      ...
      {/* IMAGE 2 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun2.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.subtitle3.BT}</BT>
        {languageData.ExtenSecretsCancun.Section3.subtitle3.text2}
      </SubtitleP>

      {/* IMAGE 3 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun3.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month1.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month2.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month3.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month4.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month5.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.seasons.month6.BT}</BT>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section3.question.BT}</BT>
      </SubtitleP>
      <SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section4.subtitle4.BT}</BT>
      ...
      <TitleH2>
        {
          languageData.ExtenSecretsCancun.Section4.questions.questionList
            .question1.title
        }
      </TitleH2>
      <SubtitleP>
      ...
      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun4.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenSecretsCancun.Section5.subtitle5.BT}</BT>
        {languageData.ExtenSecretsCancun.Section5.subtitle5.text2}
        <BT>{languageData.ExtenSecretsCancun.Section5.subtitle5.BT2}</BT>
      ...
      {/* IMAGE 5 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun5.png`}
      ...
      {/* IMAGE 6 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun6.png`}
      ...
      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun7.png`}
      ...
      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun8.png`}
      ...
      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun9.png`}
      ...
      {/* IMAGE 10 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun10.png`}
      ...
      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun11.png`}
      ...
      {/* IMAGE 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun12.png`}
      ...
      {/* SECTION 7 */}
      <TitleH2>
        {languageData.ExtenSecretsCancun.Section7.section7Title}
      </TitleH2>
      <SubtitleP>
      ...
      {/* IMAGE 13 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun13.png`}
      ...
      <ul className="gap-2 flex flex-col m-m text-fs-14 text-red-100">
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel1}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel2}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel3}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel4}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel5}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel6}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel7}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel8}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel9}</li>
        <li>{languageData.ExtenSecretsCancun.Section7.hotels.hotel10}</li>
      </ul>
      ...
      {/* IMAGE 14 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-secrets-cancun14.png`}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {
            languageData.ExtenSecretsCancun.Section8.restaurants.restaurant1
              .title
          }
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {
            languageData.ExtenSecretsCancun.Section8.restaurants.restaurant2
              .title
          }
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {
            languageData.ExtenSecretsCancun.Section8.restaurants.restaurant3
              .title
          }
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {
            languageData.ExtenSecretsCancun.Section8.restaurants.restaurant4
              .title
          }
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {
            languageData.ExtenSecretsCancun.Section8.restaurants.restaurant5
              .title
          }
        </b>
      ...
      <TitleH2>
        {
          languageData.ExtenSecretsCancun.Section9.questions.questionList
            .question1.title
        }
      </TitleH2>
      <SubtitleP>
      ...
      <SubtitleP>{languageData.ExtenSecretsCancun.Section10.text1}</SubtitleP>
      <SubtitleP>{languageData.ExtenSecretsCancun.Section10.text2}</SubtitleP>
      <SubtitleP>{languageData.ExtenSecretsCancun.Section10.text3}</SubtitleP>
