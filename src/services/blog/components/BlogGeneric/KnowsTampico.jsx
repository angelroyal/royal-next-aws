...
export default function KnowsTampico() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <div className="mb-6">
        <TitleH1>{languageData.KnowsTampico.mainTitle}</TitleH1>
      </div>

      {/* SECTION 1 OF THE BLOG */}
      <SubtitleP>
        {languageData.KnowsTampico.subtitle1.Text1}{" "}
        <BT>{languageData.KnowsTampico.subtitle1.BT}</BT>
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/knows-tampico1.jpg`}
        alt="Mejor hotel de Tampico, ubicado en la costa del Golfo de México"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.KnowsTampico.paragraphs1.Text1}</SubtitleP>
      ...
      <div className="mt-4">
        <TitleH2>{languageData.KnowsTampico.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.KnowsTampico.subtitle2.Text1}{" "}
        <BT>{languageData.KnowsTampico.subtitle2.BT}</BT>
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/knows-tampico2.png`}
        alt="Vista exterior del Soleare Hotel Boutique con piscinas y área de descanso"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.KnowsTampico.paragraphs2.Text1}</SubtitleP>

      {/* SECTION 3 OF THE BLOG */}
      {/* ROOM TYPES */}

      <div className="mt-6">
        <TitleH2>{languageData.KnowsTampico.section3Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.KnowsTampico.subtitle3}</SubtitleP>
      ...
      <SubtitleP>{languageData.KnowsTampico.paragraphsbottom3}</SubtitleP>

      {/* SECTION 4 OF THE BLOG */}
      {/* WHAT ARE THE FACILITIES */}

      <div className="mt-4">
        <TitleH2>{languageData.KnowsTampico.section4Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.KnowsTampico.subtitle4}</SubtitleP>
      ...
      <SubtitleP>{languageData.KnowsTampico.paragraphsbottom4}</SubtitleP>
      ...
      <div className="my-2">
        <TitleH2>{languageData.KnowsTampico.section5Title}</TitleH2>
      </div>
      <SubtitleP>
        <BT>{languageData.KnowsTampico.subtitle5.BT}</BT>
        {languageData.KnowsTampico.subtitle5.Text1}
      </SubtitleP>

      <SubtitleP>{languageData.KnowsTampico.paragraphs5.Text1}</SubtitleP>

      <SubtitleP>{languageData.KnowsTampico.paragraphs5.Text2}</SubtitleP>
    </div>
  );
}
