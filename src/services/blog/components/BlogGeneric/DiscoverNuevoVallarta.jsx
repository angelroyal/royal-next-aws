...
export default function DiscoverNuevoVallarta() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <div className="mb-6">
        <TitleH1>{languageData.DiscoverNuevoVallarta.mainTitle}</TitleH1>
      </div>

      <SubtitleP>
        {languageData.DiscoverNuevoVallarta.subtitle1.Text1}{" "}
        <BT>{languageData.DiscoverNuevoVallarta.subtitle1.BT}</BT>{" "}
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/discover-nuevo-vallarta1.png`}
      ...
      {/* ASK */}
      <div className="mt-4">
        <TitleH2>{languageData.DiscoverNuevoVallarta.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.DiscoverNuevoVallarta.subtitle2.Text1}{" "}
        <BT>{languageData.DiscoverNuevoVallarta.subtitle2.BT}</BT>{" "}
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/discover-nuevo-vallarta2.png`}
      ...
      {/* ROOM TYPES */}
      <div className="mt-6">
        <TitleH2>{languageData.DiscoverNuevoVallarta.section3Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.DiscoverNuevoVallarta.subtitle3}</SubtitleP>

      <SubtitleP>{languageData.DiscoverNuevoVallarta.paragraphs3}</SubtitleP>

      <div className="mt-3">
        <TitleH2>{languageData.DiscoverNuevoVallarta.section4Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.DiscoverNuevoVallarta.subtitle4}</SubtitleP>

      {/* LIST */}
      <ul className="gap-2 flex flex-col m-m text-fs-14">
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal1}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal2}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal3}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal4}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal5}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal6}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal7}</li>
        <li>{languageData.DiscoverNuevoVallarta.list1.textNormal8}</li>
      </ul>

      {/* WHAT ARE THE FACILITIES */}
      <div className="mt-4">
        <TitleH2>{languageData.DiscoverNuevoVallarta.section5Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.DiscoverNuevoVallarta.subtitle5}</SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.DiscoverNuevoVallarta.paragraphsbottom5.BT}</BT>{" "}
      ...
      {/* END BLOG */}
      <div className="my-2">
        <TitleH2>{languageData.DiscoverNuevoVallarta.section6Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.DiscoverNuevoVallarta.subtitle6.Text1}{" "}
        <BT>{languageData.DiscoverNuevoVallarta.subtitle6.BT}</BT>{" "}
        {languageData.DiscoverNuevoVallarta.subtitle6.Text2}
      </SubtitleP>

      <SubtitleP>{languageData.DiscoverNuevoVallarta.paragraphs6}</SubtitleP>
    </div>
  );
}
