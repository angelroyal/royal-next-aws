  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        {/* START BLOG */}
        <div className="mb-6">
          <TitleH1>{languageData.FindTheBestHotelIxtapa.mainTitle}</TitleH1>
        </div>
        <SubtitleP>
        ...
        {/* ROOM TYPES */}
        <div className="mt-6">
          <TitleH2>{languageData.FindTheBestHotelIxtapa.section3Title}</TitleH2>
        </div>
        ...
        <ul className="gap-2 flex flex-col m-m text-fs-14">
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold1}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal1}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold2}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal2}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold3}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal3}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold4}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal4}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold5}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal5}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold6}</BT>
            {languageData.FindTheBestHotelIxtapa.list1.textNormal6}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list1.textBold7}</BT>
        ...
        <ul className="gap-2 flex flex-col m-m text-fs-14">
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list2.textBold1}</BT>
            {languageData.FindTheBestHotelIxtapa.list2.textNormal1}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list2.textBold2}</BT>
            {languageData.FindTheBestHotelIxtapa.list2.textNormal2}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list2.textBold3}</BT>
            {languageData.FindTheBestHotelIxtapa.list2.textNormal3}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list2.textBold4}</BT>
            {languageData.FindTheBestHotelIxtapa.list2.textNormal4}
          </li>
          <li>
            <BT>{languageData.FindTheBestHotelIxtapa.list2.textBold5}</BT>
