...
export default function FindBestHotelPuntaCanaAi() {
  ...
  const TableBlog = {
    ...
    date: ["Mar 2024", "Mar 2024", "Mar 2024", "Hace 2 meses"],
  ...
  return (
    <>
      <div className="flex flex-col gap-3">
        {/* START BLOG */}
        <div className="mb-6">
          <TitleH1>{languageData.FindBestHotelPuntaCanaAi.mainTitle}</TitleH1>
        </div>
        <SubtitleP>
          {languageData.FindBestHotelPuntaCanaAi.subtitle1.Text1}
          <BT>{languageData.FindBestHotelPuntaCanaAi.subtitle1.BT}</BT>
          {languageData.FindBestHotelPuntaCanaAi.subtitle1.Text2}
        </SubtitleP>
        {/* IMAGE 1 */}

        <img
          src={`${process.env.NEXT_PUBLIC_URL}img/blog/find-best-hotel-all-inclusive-punta-cana.jpg`}
        ...
        <div className="mt-4">
          <TitleH2>
            {languageData.FindBestHotelPuntaCanaAi.section2Title}
          </TitleH2>
        </div>
        <SubtitleP>
        ...
        <img
          src={`${process.env.NEXT_PUBLIC_URL}img/blog/find-best-hotel-all-inclusive-punta-cana2.jpg`}
        ...
        <ul className="gap-2 flex flex-col m-m text-fs-14">
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal1}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal2}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal3}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal4}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal5}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal6}</li>
          <li>{languageData.FindBestHotelPuntaCanaAi.list1.textNormal7}</li>
        </ul>
        ...
        <SubtitleP>
          {languageData.FindBestHotelPuntaCanaAi.paragraphBottom1.Text3}
        </SubtitleP>

        {/* WHAT ARE THE FACILITIES */}
        <div className="mt-4">
          <TitleH2>
            {languageData.FindBestHotelPuntaCanaAi.section4Title}
          </TitleH2>
        </div>
        ...
        <div className="my-4">
          <TableReviews
            TableBlog={languageData.FindBestHotelPuntaCanaAi.table}
          />
        </div>
        ...
        <div className="my-2">
          <TitleH2>
            {languageData.FindBestHotelPuntaCanaAi.section5Title}
          </TitleH2>
        </div>
        <SubtitleP>
