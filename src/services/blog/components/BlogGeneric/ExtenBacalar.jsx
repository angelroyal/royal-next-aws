  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtendBacalar.Section1.paragraphs1.BT}</BT>
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtendBacalar.Section2.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.ExtendBacalar.Section2.subtitle2.Text1}
        <BT>{languageData.ExtendBacalar.Section2.subtitle2.BT}</BT>
      ...
      {/* IMAGE 2 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar2.png`}
      ...
      <TitleH2>{languageData.ExtendBacalar.Section3.section3Title}</TitleH2>

      <SubtitleP>
        {languageData.ExtendBacalar.Section3.subtitle2.Text1}
        <BT>{languageData.ExtendBacalar.Section3.subtitle2.BT}</BT>
        {languageData.ExtendBacalar.Section3.subtitle2.Text2}
      </SubtitleP>

      {/* IMAGE 3 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar3.png`}
      ...
      <div className="my-2">
        <TitleH2>
          {
            languageData.ExtendBacalar.Section3.Questions.Question1
              .QuestionTitle
          }
        </TitleH2>
      </div>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question1
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question1
            .QuestionSubtitle.Text2
        }
      </SubtitleP>
      ...
      <div className="my-2">
        <TitleH2>
          {
            languageData.ExtendBacalar.Section3.Questions.Question2
              .QuestionTitle
          }
        </TitleH2>
      </div>
      ...
      <div className="my-2">
        <TitleH2>
          {
            languageData.ExtendBacalar.Section3.Questions.Question3
              .QuestionTitle
          }
        </TitleH2>
      </div>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text1
        }
      </SubtitleP>
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text2
        }
      </SubtitleP>
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text3
        }
      </SubtitleP>
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text4
        }
      </SubtitleP>
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text5
        }
        <BT>
          {
            languageData.ExtendBacalar.Section3.Questions.Question3
              .QuestionParagraph.BT
          }
        </BT>
        {
          languageData.ExtendBacalar.Section3.Questions.Question3
            .QuestionParagraph.Text6
        }
      </SubtitleP>

      <TitleH2>{languageData.ExtendBacalar.Section4.section4Title}</TitleH2>
      <SubtitleP>
        {languageData.ExtendBacalar.Section4.subtitle4.Text1}
        <BT>{languageData.ExtendBacalar.Section4.subtitle4.BT}</BT>
      ...
      <SubtitleP>
        <BT>{languageData.ExtendBacalar.Section4.places.place1.BT}</BT>
      ...
      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar4.png`}
      ...
      {/* IMAGE 5 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar5.png`}
      ...
      <SubtitleP>
        <BT>
          <span className="italic">
            {
              languageData.ExtendBacalar.Section4.places.place4.cenotes.cenote1
                .title
            }
          </span>
        </BT>{" "}
      ...
      {/* IMAGE 6 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar6.png`}
      ...
      <SubtitleP>
        <BT>
          <span className="italic">
            {
              languageData.ExtendBacalar.Section4.places.place4.cenotes.cenote2
                .title
            }
          </span>
        </BT>{" "}
      ...
      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar7.png`}
      ...
      <SubtitleP>
        <BT>
          <span className="italic">
            {
              languageData.ExtendBacalar.Section4.places.place4.cenotes.cenote3
                .title
            }
          </span>
        </BT>{" "}
      ...
      <SubtitleP>
        <BT>
          <span className="italic">
            {
              languageData.ExtendBacalar.Section4.places.place4.cenotes.cenote4
                .title
            }
          </span>
        </BT>{" "}
      ...
      <TitleH2>
        {languageData.ExtendBacalar.Section4.places.place5.title}
      </TitleH2>
      <SubtitleP>
      ...
      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar8.png`}
      ...
      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar9.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtendBacalar.Section5.subtitle5.BT}</BT>
      </SubtitleP>

      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar11.png`}
        alt="Servicio y calidad en los mejores hoteles de Bacalar"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.ExtendBacalar.Section5.paragraph5}</SubtitleP>

      {/* LIST RED*/}
      <ul className="gap-2 flex flex-col m-s-b text-fs-14 text-red-100">
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel1}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel2}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel3}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel4}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel5}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel6}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel7}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel8}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel9}</li>
        <li>{languageData.ExtendBacalar.Section5.hotels.hotel10}</li>
      </ul>

      <TitleH2>{languageData.ExtendBacalar.Section6.section6Title}</TitleH2>
      <SubtitleP>
      ...
      {/* IMAGE 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar12.png`}
      ...
      <TitleH2>{languageData.ExtendBacalar.Section7.section7Title}</TitleH2>

      <SubtitleP>
        <BT>
          <span className="text-fs-16">
            {
              languageData.ExtendBacalar.Section7.Questions.Question1
                .QuestionTitle
            }
          </span>
        </BT>
      ...
      {/* IMAGE 13 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-bacalar13.png`}
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section7.Questions.Question2
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section7.Questions.Question3
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      <SubtitleP>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section7.Questions.Question4
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section7.Questions.Question5
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      ...
      <SubtitleP>
        {
          languageData.ExtendBacalar.Section7.Questions.Question6
            .QuestionSubtitle.Text1
        }
      </SubtitleP>
      <SubtitleP>
      ...
      {/* END BLOG */}
      <TitleH2>{languageData.ExtendBacalar.Section8.section8Title}</TitleH2>
      <SubtitleP>{languageData.ExtendBacalar.Section8.subtitle8}</SubtitleP>
      <SubtitleP>
