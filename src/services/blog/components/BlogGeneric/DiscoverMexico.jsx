...
export default function DiscoverMexico() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <div className="mb-6">
        <TitleH1>{languageData.DiscoverMexico.mainTitle}</TitleH1>
      </div>

      <SubtitleP>
        {languageData.DiscoverMexico.subtitle1.Text1}{" "}
        <BT>{languageData.DiscoverMexico.subtitle1.BT}</BT>{" "}
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/discover-mexico1.png`}
        alt="Vista de la entrada principal del mejor hotel de la Ciudad de México"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.DiscoverMexico.paragraphs1.Text1}</SubtitleP>

      <SubtitleP>{languageData.DiscoverMexico.paragraphs1.Text2}</SubtitleP>

      {/* ASK */}
      <div className="mt-4">
        <TitleH2>{languageData.DiscoverMexico.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.DiscoverMexico.subtitle2.Text1}{" "}
        <BT>{languageData.DiscoverMexico.subtitle2.BT}</BT>{" "}
      </SubtitleP>

      {/* IMAGE 2 */}

      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/discover-mexico2.png`}
        alt="Vista de entrada principal del hote Four Seasons Hotel México City"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.DiscoverMexico.paragraphs2.Text1}</SubtitleP>

      {/* ROOM TYPES */}
      <div className="mt-6">
        <TitleH2>{languageData.DiscoverMexico.section3Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.DiscoverMexico.subtitle3}</SubtitleP>

      <SubtitleP>{languageData.DiscoverMexico.paragraphs2.Text1}</SubtitleP>
      <SubtitleP>{languageData.DiscoverMexico.paragraphs2.Text2}</SubtitleP>
      ...
      <SubtitleP>{languageData.DiscoverMexico.paragraphsbottom3}</SubtitleP>

      {/* WHAT ARE THE FACILITIES */}
      <div className="mt-4">
        <TitleH2>{languageData.DiscoverMexico.section4Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.DiscoverMexico.subtitle4}</SubtitleP>
      ...
      <SubtitleP>{languageData.DiscoverMexico.paragraphsbottom4}</SubtitleP>
      ...
      {/* END BLOG */}
      <div className="my-2">
        <TitleH2>{languageData.DiscoverMexico.section5Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.DiscoverMexico.subtitle5.Text1}{" "}
        <BT>{languageData.DiscoverMexico.subtitle5.BT}</BT>{" "}
        {languageData.DiscoverMexico.subtitle5.Text2}{" "}
      </SubtitleP>

      <SubtitleP>{languageData.DiscoverMexico.paragraphs5}</SubtitleP>
    </div>
  );
}
