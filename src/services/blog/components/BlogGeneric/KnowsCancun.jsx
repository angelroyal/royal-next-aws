...
export default function KnowsCancun() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="mb-6">
        <TitleH1>{languageData.KnowsCancun.mainTitle}</TitleH1>
      </div>

      <SubtitleP>
        {languageData.KnowsCancun.subtitle1.Text1}{" "}
        <BT>{languageData.KnowsCancun.subtitle1.BT}</BT>
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/knows-cancun1.jpg`}
      ...
      <SubtitleP>{languageData.KnowsCancun.paragraphs1.Text1}</SubtitleP>

      {/* ASK */}
      <div className="mt-4">
        <TitleH2>{languageData.KnowsCancun.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.KnowsCancun.subtitle2.Text1}{" "}
        <BT>{languageData.KnowsCancun.subtitle2.BT}</BT>
      ...
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/knows-cancun2.png`}
      ...
      <SubtitleP>{languageData.KnowsCancun.paragraphs2.Text1}</SubtitleP>

      {/* ROOM TYPES */}
      <div className="mt-6">
        <TitleH2>{languageData.KnowsCancun.section3Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.KnowsCancun.subtitle3}</SubtitleP>

      <SubtitleP>{languageData.KnowsCancun.paragraphs3}</SubtitleP>
      ...
      <SubtitleP>{languageData.KnowsCancun.paragraphsbottom3}</SubtitleP>
      ...
      <div className="mt-4">
        <TitleH2>{languageData.KnowsCancun.section4Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.KnowsCancun.subtitle4}</SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.KnowsCancun.paragraphsbottom4.BT}</BT>
      ...
      {/* END BLOG */}
      <div className="my-2">
        <TitleH2>{languageData.KnowsCancun.section5Title}</TitleH2>
      </div>

      <SubtitleP>
        {languageData.KnowsCancun.subtitle5.Text1}{" "}
        <BT>{languageData.KnowsCancun.subtitle5.BT}</BT>
        {languageData.KnowsCancun.subtitle5.Text2}
      </SubtitleP>

      <SubtitleP>{languageData.KnowsCancun.paragraphs5.Text1}</SubtitleP>

      <SubtitleP>{languageData.KnowsCancun.paragraphs5.Text2}</SubtitleP>
    </div>
  );
}
