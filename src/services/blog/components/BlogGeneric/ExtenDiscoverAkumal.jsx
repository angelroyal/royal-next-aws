...
export default function ExtenDiscoverAkumal() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <TitleH1>{languageData.ExtenDiscoverAkumal.mainTitle}</TitleH1>

      <SubtitleP>{languageData.ExtenDiscoverAkumal.subtitle1}</SubtitleP>

      {/* IMAGE 1 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal1.png`}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.paragraphs1.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.paragraphs1.Text2}{" "}
      </SubtitleP>

      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.paragraphs1.Text3}{" "}
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenDiscoverAkumal.section2Title}</TitleH2>
      </div>
      ...
      {/* IMAGE 2 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal2.png`}
      ...
      <SubtitleP>
        <BT>
          {languageData.ExtenDiscoverAkumal.paragraphs2.paragraphsBottom.BT}
        </BT>{" "}
      ...
      <SubtitleP>{languageData.ExtenDiscoverAkumal.subtitle3}</SubtitleP>
      ...
      {/* IMAGE 3 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal3.png`}
      ...
      <div className="my-2">
        <TitleH2>
          {" "}
          {
            languageData.ExtenDiscoverAkumal.Characteristics.Characteristic1
              .Title
          }{" "}
        </TitleH2>
      </div>
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.Characteristics.Characteristic1.Text1
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.Characteristics.Characteristic1.Text2}
      </SubtitleP>
      ...
      <div className="my-2">
        <TitleH2>
          {" "}
          {
            languageData.ExtenDiscoverAkumal.Characteristics.Characteristic2
              .Title
          }{" "}
        </TitleH2>
      </div>
      ...
      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal4.png`}
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.Characteristics.Characteristic2.Text1
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.Characteristics.Characteristic2.Text2}
      </SubtitleP>
      ...
      <div className="my-2">
        <TitleH2>
          {" "}
          {
            languageData.ExtenDiscoverAkumal.Characteristics.Characteristic3
              .Title
          }{" "}
        </TitleH2>
      </div>
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.Characteristics.Characteristic3.Text1
        }{" "}
      </SubtitleP>
      ...
      {/* IMAGE 5 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal5.png`}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.places.place1.Text2}{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.places.place2.Text2}
      </SubtitleP>
      ...
      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.places.place3.Text2}
      </SubtitleP>

      {/* IMAGE 6 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal6.png`}
      ...
      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.places.place5.Text2}
      </SubtitleP>

      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal7.png`}
      ...
      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal8.png`}
      ...
      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal9.png`}
      ...
      <SubtitleP>{languageData.ExtenDiscoverAkumal.subtitle5}</SubtitleP>

      {/* IMAGE 10 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal10.png`}
        alt="Autobús de Playa del Carmen a Akumal"
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <TitleH2>
        {languageData.ExtenDiscoverAkumal.travelerQuestions.Question1.Question}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.travelerQuestions.Question1.Text1
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.travelerQuestions.Question1.Text2
        }{" "}
      </SubtitleP>

      <TitleH2>
        {languageData.ExtenDiscoverAkumal.travelerQuestions.Question2.Question}{" "}
      </TitleH2>
      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.travelerQuestions.Question2.Text1}{" "}
        <BT>
          {languageData.ExtenDiscoverAkumal.travelerQuestions.Question2.BT}
        </BT>
        {languageData.ExtenDiscoverAkumal.travelerQuestions.Question2.Text2}
      </SubtitleP>

      <TitleH2>
        {languageData.ExtenDiscoverAkumal.travelerQuestions.Question3.Question}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.travelerQuestions.Question3.Text1
        }{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>
          {languageData.ExtenDiscoverAkumal.travelerQuestions.Question3.BT}
        </BT>
      </SubtitleP>

      <TitleH2>{languageData.ExtenDiscoverAkumal.section6Title}</TitleH2>

      <SubtitleP>{languageData.ExtenDiscoverAkumal.subtitle6}</SubtitleP>

      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal11.png`}
        alt="Mejores hoteles de akumal "
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <SubtitleP>{languageData.ExtenDiscoverAkumal.paragraph6}</SubtitleP>
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenDiscoverAkumal.section7Title}</TitleH2>
      </div>

      <TitleH2>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question1.Title}
      </TitleH2>

      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question1.answers.Text1}{" "}
      </SubtitleP>

      {/* IMAGE 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-discover-akumal12.png`}
      ...
      <TitleH2>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question2.Title}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question2.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question2.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question2.answers.Text3}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question3.Title}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question3.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question3.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question3.answers.Text3}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question4.Title}
      </TitleH2>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.faqs.question4.answers.Text3}{" "}
      </SubtitleP>

      <div className="my-2">
        <TitleH2>{languageData.ExtenDiscoverAkumal.section8Title}</TitleH2>
      </div>

      <SubtitleP> {languageData.ExtenDiscoverAkumal.subtitle8} </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.paragraphs8.paragraphsTop.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenDiscoverAkumal.paragraphs8.paragraphsTop.Text2}{" "}
      </SubtitleP>

      <SubtitleP>
        {languageData.ExtenDiscoverAkumal.paragraphs8.paragraphsBottom.Text1}{" "}
        <BT>
          {languageData.ExtenDiscoverAkumal.paragraphs8.paragraphsBottom.BT}
        </BT>
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenDiscoverAkumal.paragraphs8.paragraphsBottom.Text3
        }{" "}
      </SubtitleP>
    </div>
  );
