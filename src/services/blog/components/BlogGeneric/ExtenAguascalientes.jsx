...
export default function ExtenAguascalientes() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* IMAGE 1 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes1.png`}
      ...
      <SubtitleP>{languageData.ExtenAguascalientes.subtitle2}</SubtitleP>
      ...
      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs2.paragraphTop.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs2.paragraphTop.Text1}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {
          languageData.ExtenAguascalientes.paragraphs2.paragraphBottom.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.paragraphs2.paragraphBottom.Text1
        }{" "}
      </SubtitleP>

      <div className="my-3">
        <TitleH2>{languageData.ExtenAguascalientes.section3Title}</TitleH2>
      </div>
      ...
      {/* IMAGE 3 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes3.png`}
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic1.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic1
            .Subtitle
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic1.Text1
        }{" "}
      </SubtitleP>
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic2.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic2
            .Subtitle
        }{" "}
      </SubtitleP>
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic3.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic3
            .Subtitle
        }{" "}
      </SubtitleP>
      ...
      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes4.png`}
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic3.Text1
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic3.Text2
        }{" "}
      </SubtitleP>
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic4.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic4
            .Subtitle
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenAguascalientes.Characteristics.Characteristic4.Text1
        }{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs4.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs4.Text2}{" "}
      </SubtitleP>

      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.placesOfInterest.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.placesOfInterest.Text3}{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place1.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place2.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place3.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place4.Title}{" "}
        </b>{" "}
      ...
      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes7.png`}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place5.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place6.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place7.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place8.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.places.place9.Title}{" "}
        </b>{" "}
      ...
      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes8.png`}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.museums.museum1.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.museums.museum2.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.museums.museum3.Title}{" "}
        </b>{" "}
      ...
      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes9.png`}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.museums.museum4.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.museums.museum5.Title}{" "}
        </b>{" "}
      ...
      <SubtitleP>
        ...
        <span className="italic">
          {" "}
          {languageData.ExtenAguascalientes.paragraph7.Text2}
        </span>
      </SubtitleP>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity1.Title}{" "}
        </b>
      ...
      {/* IMAGE 10 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes10.png`}
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity2.Title}{" "}
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity3.Title}{" "}
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity4.Title}{" "}
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity5.Title}{" "}
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity6.Title}{" "}
        </b>
      ...
      <SubtitleP>
        <b className="text-black text-fs-16">
          {" "}
          {languageData.ExtenAguascalientes.activities.activity7.Title}{" "}
        </b>
      ...
      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes11.png`}
      ...
      <TitleH2>{languageData.ExtenAguascalientes.section9Title}</TitleH2>
      ...
      {/* IMAGE 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes12.png`}
      ...
      <SubtitleP>
        <BT>
          {languageData.ExtenAguascalientes.gastronomy.desserts.dessert1.Title}
        </BT>{" "}
        {
          languageData.ExtenAguascalientes.gastronomy.desserts.dessert1
            .description
        }
      </SubtitleP>
      ...
      <SubtitleP>
        <BT>
          {languageData.ExtenAguascalientes.gastronomy.desserts.dessert2.Title}
        </BT>{" "}
        {
          languageData.ExtenAguascalientes.gastronomy.desserts.dessert2
            .description
        }
      </SubtitleP>
      ...
      <SubtitleP>
        <BT>
          {languageData.ExtenAguascalientes.gastronomy.desserts.dessert3.Title}
        </BT>{" "}
        {
          languageData.ExtenAguascalientes.gastronomy.desserts.dessert3
            .description
        }
      </SubtitleP>
      ...
      <SubtitleP>
        <BT>
          {languageData.ExtenAguascalientes.gastronomy.desserts.dessert4.Title}
        </BT>{" "}
        {
          languageData.ExtenAguascalientes.gastronomy.desserts.dessert4
            .description
        }
      </SubtitleP>

      <div className="my-3">
        <TitleH2>{languageData.ExtenAguascalientes.section10Title}</TitleH2>
      </div>

      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question1.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question1.answers.Text1}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question2.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question2.answers.Text1}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question3.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question3.answers.Text1}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question4.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question4.answers.Text1}{" "}
      </SubtitleP>

      <TitleH2>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question5.Title}{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.faqs.question5.answers.Text1}{" "}
      </SubtitleP>

      {/* IMAGE 13 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-aguascalientes13.png`}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs11.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenAguascalientes.paragraphs11.Text2}{" "}
      </SubtitleP>
    </div>
  );
}
