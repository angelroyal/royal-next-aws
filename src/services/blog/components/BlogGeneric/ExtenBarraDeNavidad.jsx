...
export default function ExtenBarraDeNavidad() {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* START BLOG */}
      <TitleH1>{languageData.ExtenBarraDeNavidad.mainTitle}</TitleH1>

      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle1}</SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenBarraDeNavidad.paragraphs1.BT1}</BT>{" "}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenBarraDeNavidad.paragraphs1.BT2}</BT>{" "}
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenBarraDeNavidad.section2Title}</TitleH2>
      </div>

      <SubtitleP>
        <BT>{languageData.ExtenBarraDeNavidad.subtitle2.BT1}</BT>{" "}
        {languageData.ExtenBarraDeNavidad.subtitle2.Text1}{" "}
        <BT>{languageData.ExtenBarraDeNavidad.subtitle2.BT2}</BT>{" "}
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenBarraDeNavidad.section3Title}</TitleH2>
      </div>

      <SubtitleP>
        <BT>{languageData.ExtenBarraDeNavidad.subtitle3.BT}</BT>{" "}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenBarraDeNavidad.paragraphs3.BT}</BT>{" "}
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenBarraDeNavidad.section4Title}</TitleH2>
      </div>

      <SubtitleP>
        <BT>{languageData.ExtenBarraDeNavidad.subtitle4.BT}</BT>
        {languageData.ExtenBarraDeNavidad.subtitle4.Text1}
      </SubtitleP>

      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad4.png`}
      ...
      <div className="my-2">
        <TitleH2>{languageData.ExtenBarraDeNavidad.section5Title}</TitleH2>
      </div>

      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle5}</SubtitleP>
      ...
      <TitleH2>{languageData.ExtenBarraDeNavidad.section6Title}</TitleH2>

      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle6}</SubtitleP>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.paragraphs6}</SubtitleP>
      ...
      {/* IMAGE 6 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad6.png`}
      ...
      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad7.png`}
      ...
      <SubtitleP>
        ...
        <BT>{languageData.ExtenBarraDeNavidad.places.place3.description.BT}</BT>{" "}
        {languageData.ExtenBarraDeNavidad.places.place3.description.Text2}
      </SubtitleP>

      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad8.png`}
      ...
      <TitleH2>{languageData.ExtenBarraDeNavidad.section7Title}</TitleH2>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle7}</SubtitleP>

      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad9.png`}
      ...
      <TitleH2>{languageData.ExtenBarraDeNavidad.section8Title}</TitleH2>

      <SubtitleP>
        {languageData.ExtenBarraDeNavidad.subtitle8.Text1}{" "}
        <BT>{languageData.ExtenBarraDeNavidad.subtitle8.BT1}</BT>{" "}
      ...
      {/* IMAGE 10 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad10.png`}
      ...
      <ul className="gap-2 flex flex-col m-m text-fs-14">
        <li>
          <SubtitleP>
            ...
            {
              languageData.ExtenBarraDeNavidad.gastronomy.restaurant1
                .description
            }
          </SubtitleP>
        </li>
        ...
        <li>
          <SubtitleP>
            ...
            {
              languageData.ExtenBarraDeNavidad.gastronomy.restaurant2
                .description
            }
          </SubtitleP>
        </li>
        ...
        <li>
          <SubtitleP>
            ...
            {
              languageData.ExtenBarraDeNavidad.gastronomy.restaurant3
                .description
            }
          </SubtitleP>
        </li>
        ...
        <li>
          <SubtitleP>
            ...
            {
              languageData.ExtenBarraDeNavidad.gastronomy.restaurant4
                .description
            }
          </SubtitleP>
        </li>
        ...
        <li>
          <SubtitleP>
            ...
            {
              languageData.ExtenBarraDeNavidad.gastronomy.restaurant5
                .description
            }
          </SubtitleP>
        </li>
      ...
      <TitleH2>{languageData.ExtenBarraDeNavidad.section9Title}</TitleH2>

      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle9}</SubtitleP>
      ...
      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad11.png`}
        ...
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />
      <TitleH2>{languageData.ExtenBarraDeNavidad.section10Title}</TitleH2>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle10}</SubtitleP>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.paragraphs10}</SubtitleP>

      <TitleH2>{languageData.ExtenBarraDeNavidad.section11Title}</TitleH2>
      <SubtitleP>
        {languageData.ExtenBarraDeNavidad.subtitle11.Text1}{" "}
        <BT>{languageData.ExtenBarraDeNavidad.subtitle11.BT1}</BT>{" "}
      ...
      <TitleH2>{languageData.ExtenBarraDeNavidad.section12Title}</TitleH2>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle12}</SubtitleP>
      <SubtitleP>
      ...
      {/* IMAGE 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-barra-navidad12.png`}
        alt="Vista de la orilla del mar, frente al mar hay una pequeña área verde con un pasto que destaca y una palmera."
        className="rounded-lg h-[437px] object-cover w-full my-6"
      />

      <TitleH2>{languageData.ExtenBarraDeNavidad.section13Title}</TitleH2>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question1.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question1.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question1.answers.Text3}{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question2.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question2.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.faqs.question2.answers.Text3}{" "}
      </SubtitleP>

      <TitleH2>{languageData.ExtenBarraDeNavidad.section14Title}</TitleH2>
      <SubtitleP>{languageData.ExtenBarraDeNavidad.subtitle14}</SubtitleP>

      <SubtitleP>
        {languageData.ExtenBarraDeNavidad.paragraphs14.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.paragraphs14.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenBarraDeNavidad.paragraphs14.Text3}{" "}
      </SubtitleP>
    </div>
  );
}
