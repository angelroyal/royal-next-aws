...
export default function ExtenComeAcapulco() {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      {/* IMAGE 1 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco1.png`}
      ...
      <SubtitleP>
        ...
        <BT>
          {languageData.ExtenComeAcapulco.paragraphs1.paragraphBottom.BT1}
        </BT>{" "}
        {languageData.ExtenComeAcapulco.paragraphs1.paragraphBottom.Text2}{" "}
        <BT>
          {languageData.ExtenComeAcapulco.paragraphs1.paragraphBottom.BT2}
        </BT>
      </SubtitleP>
      ...
      <TitleH2>
        {languageData.ExtenComeAcapulco.travelerQuestions.Question1.Question}
      </TitleH2>
      <SubtitleP>
      ...
      <TitleH2>
        {languageData.ExtenComeAcapulco.travelerQuestions.Question2.Question}
      </TitleH2>
      <SubtitleP>
      ...
      <SubtitleP>
        {languageData.ExtenComeAcapulco.travelerQuestions.Question2.Text3}
      </SubtitleP>

      <TitleH2>
        {languageData.ExtenComeAcapulco.travelerQuestions.Question3.Question}
      </TitleH2>
      <SubtitleP>
      ...
      <div className="my-3">
        <TitleH2>{languageData.ExtenComeAcapulco.section3Title}</TitleH2>
      </div>
      <SubtitleP>
      ...
      {/* IMAGE 2 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco2.png`}
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic1.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic1
            .Subtitle
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic1.Text1
        }{" "}
      </SubtitleP>
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic2.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic2
            .Subtitle
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic2.Text1
        }{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        ...
        <BT>
          {languageData.ExtenComeAcapulco.Characteristics.Characteristic2.BT}
        </BT>{" "}
      ...
      {/* IMAGE 3 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco3.png`}
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic3.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic3
            .Subtitle
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic3.points
            .point1
        }{" "}
      </SubtitleP>
      <SubtitleP>
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic3.Text1
        }{" "}
      </SubtitleP>
      ...
      <TitleH2>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic4.Title
        }{" "}
      </TitleH2>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic4
            .Subtitle
        }{" "}
      </SubtitleP>
      ...
      {/* IMAGE 4 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco4.png`}
      ...
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic4.Text1
        }{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {
          languageData.ExtenComeAcapulco.Characteristics.Characteristic4.Text2
        }{" "}
      </SubtitleP>

      <TitleH2>{languageData.ExtenComeAcapulco.section4Title}</TitleH2>
      ...
      {/* IMAGE 5 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco5.png`}
      ...
      {/* IMAGE 6 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco6.png`}
      ...
      {/* IMAGE 7 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco7.png`}
      ...
      {/* IMAGE 8 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco8.png`}
      ...
      {/* IMAGE 9 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco9.png`}
      ...
      {/* IMAGE 10 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco10.png`}
      ...
      {/* IMAGE 11 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco11.png`}
      ...
      {/* Image 12 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco12.png`}
      ...
      <TitleH2>{languageData.ExtenComeAcapulco.section8Title}</TitleH2>

      <SubtitleP> {languageData.ExtenComeAcapulco.subtitle8} </SubtitleP>

      {/* IMAGE 13 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco13.png`}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.paragraphs8.Text1}{" "}
      </SubtitleP>
      ...
      {/* CURRENT QUESTIONS */}
      <TitleH2>{languageData.ExtenComeAcapulco.section9Title}</TitleH2>

      <TitleH2> {languageData.ExtenComeAcapulco.faqs.question1.Title} </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question1.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question1.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question2.answers.Text1}{" "}
      </SubtitleP>

      <TitleH2> {languageData.ExtenComeAcapulco.faqs.question3.Title} </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question3.answers.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question3.answers.Text2}{" "}
      </SubtitleP>

      <TitleH2> {languageData.ExtenComeAcapulco.faqs.question4.Title} </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question4.answers.Text1}{" "}
      </SubtitleP>

      {/* IMAGE 14 */}
      <img
        src={`${process.env.NEXT_PUBLIC_URL}img/blog/exten-come-acapulco14.png`}
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question4.answers.Text2}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question4.answers.Text3}{" "}
      </SubtitleP>

      <TitleH2> {languageData.ExtenComeAcapulco.faqs.question5.Title} </TitleH2>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.faqs.question5.answers.Text1}{" "}
      </SubtitleP>
      ...
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.paragraphs10.Text1}{" "}
      </SubtitleP>
      <SubtitleP>
        {" "}
        {languageData.ExtenComeAcapulco.paragraphs10.Text2}{" "}
      </SubtitleP>
