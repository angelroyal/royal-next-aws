        ...
        <div className="flex gap-[16px] h-[318px] mb-[40px]">
            <div className="flex bg-white justify-center items-center shadow-3xl w-1/2">
                <div className="w-full h-full flex justify-center !bg-white">
                    <Image src={`${process.env.NEXT_PUBLIC_URL}test/hotel-banner-home.jpg`} width={547} height={235} className="w-full rounded-lg object-cover object-center select-none" alt="Banner Exc Discounts" />
                </div>
            </div>
