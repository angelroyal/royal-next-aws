...
export function HoursSelect() {
  const { dayTour, setHourTour, isLoader } = useContext(DetailTourContext);
        ...
        <>
          {dayTour.times.every((hour) => hour.time === "") ? (
            <div className="text-center py-9">
              <p className="text-black text-fs-14">
                {languageData.modalTour.doesNotTime}
              </p>
            </div>
          ) : (
            <div className="py-9">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-5 md:grid-cols-6 lg:grid-cols-5 2xl:grid-cols-6 gap-x-4 gap-y-[9px] xl:pr-[63px]">
                {dayTour.times
                    ...
                    <div
                      ...
                      className={`${
                        indexSelected === index
                          ...
                          : isLoader
                          ? " cursor-not-allowed"
                          : " hover:bg-gry-30 border-gry-70 cursor-pointer"
                      } border rounded py-2 px-4 w-[83px] `}
                      key={index}
                    >
                      <p
                        className={`${
