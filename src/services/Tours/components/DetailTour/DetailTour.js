...
import SelectTour from "../Modal/SelectTour";
...
import GeneralInformationTourModal from "../Modal/GeneralInformationTourModal";
...
import InfoGray from "../../../../assets/icons/utils/others/info-gray.svg";
import InfoWhite from "../../../../assets/icons/utils/others/info-withe.svg";
import MoneyGray from "../../../../assets/icons/utils/others/money-gray.svg";
import MoneyWhite  from "../../../../assets/icons/utils/others/money-white.svg";

import "../../../../assets/styles/web/GalleryTour.css";
import "../../../../assets/styles/mobile/GalleryTour.css";
import "../../../../assets/styles/web/Tour/StyleModalTourNw.css"; 
      ...
      {tourInfo && combinedRates.length > 0 ? (
        <>
          ...
          <button
            ...
            onClick={() => closeDialog()}
          >
            <Image src={IconLeft} alt="IconLeft" className="icon-left-m" />
          ...
          <div className="line-down">
            ...
            <div className="d-flex gap-2 align-items-center width100">
              <div className="d-flex">
                <Image src={IconLocation} alt="IconLocation" width={20} height={20} />
          ...
          <div className="d-flex select-info-tour-modal">
            ...
            >
              {menuModalTour === 1 ? (
                <Image src={MoneyWhite} alt="MoneyWhite" width={40} height={21} />
              ) : (
                <Image src={MoneyGray} alt="MoneyGray" width={40} height={21} />
              )}
            ...
            >
              {menuModalTour === 2 ? (
                <Image src={InfoWhite} alt="InfoWhite" width={40} height={21} />
              ) : (
                <Image src={InfoGray} alt="InfoGray" width={40} height={21} />
              )}
