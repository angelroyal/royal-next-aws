...
export default function PendingPaymentSkeleton() {
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="bg-gry-30 w-full h-[17rem] flex rounded-lg py-[32px] px-[24px] shadow-[1px_0px_20px_1px_rgba(189,183,183,0.75)] gap-x-[32px] max-lg:flex-col max-lg:h-auto ">
