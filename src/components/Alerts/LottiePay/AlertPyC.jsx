...
export function AlertPyC({
  ...
  return (
    openAlert && (
      <div
        ref={ref}
        className="cursor-auto absolute z-1 shadow-3xl bg-white rounded-lg w-[316px] md:w-[458px] translate-x-[-67%] md:translate-x-[-50%] h-auto p-4 flex flex-col items-center"
      >
        <img
