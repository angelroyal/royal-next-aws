        ...
        <div className='relative w-full flex items-center my-32 max-lg:items-start '>
            ...
            <div className='absolute flex flex-col ml-[92px] max-lg:mx-[40px] max-lg:mt-[90px] max-sm:mt-[40px]'>
                ...
                <div className='flex gap-2 mt-[35px] max-lg:flex-col'>
                    <input type="text" placeholder="Escribe aquí tu nombre"  className='h-[44px] rounded-[4px] w-[257px] pl-[10px] m-s-b text-fs-12 max-lg:w-full'/>
                    <input type="tel" placeholder="Numero de celular" className='h-[44px] pl-[10px] w-[257px] rounded-[4px] m-s-b text-fs-12 max-lg:w-full'/>
