        ...
        <div className='p-4'>
            ...
            <div className='border-t border-[#ebebeb] mt-4 pt-4'>
                ...
                <div className='flex justify-end gap-4 mt-4'>
                    <button className='text-fs-12 text-bl-100 m-s-b border-2 border-bl-100 rounded-full py-[14px] px-[16px] hover:bg-bl-100 hover:text-white'>Resetear carrito</button>
                    <button className='text-fs-12 text-white m-s-b bg-bl-100 rounded-full py-[14px] px-[16px] hover:bg-bl-70'>Finalizar compra</button>
                </div>
            </div>
        </div>
    )
