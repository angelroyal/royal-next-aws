        ...
        >
            {delayContact &&
                ...
                <div
                    ...
                    className={`fixed bottom-[1.9rem] right-[2rem] flex items-center gap-2 bg-white h-[50px] mb-[10px] w-fit rounded-tr-2xl rounded-l-3xl shadow-3xl cursor-pointer no-underline z-[9] max-md:rounded-full ${delayClass ? "bounce2" : "animations-icon"
                        }`}
                >
            ...
            {delayIcon &&
                <div className={`bg-bl-100 p-[1rem] rounded-full border border-white fixed bottom-[39px] right-[149px] z-[9] max-md:right-[36px]
