...
export default function Test2() {
  return (
    <div>
    <h1 class="m-b text-[1.5rem] pt-[4rem] pb-[2rem] text-bl-100">TERMS AND CONDITIONS</h1>
    <h2 class="m-b text-[.938rem] pb-[0.5rem]">INTRODUCTION </h2>
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      Welcome to the www.royalvacationsmexico.com website (“
      <span class="m-b text-[.875rem]">Royal Vacations México</span>”),
      ...
      Conditions.
      <span class="m-b text-[.875rem]">Royal Vacations México</span> reserves
      the right to add to or modify the Terms and Conditions at any time. All
      added or modified terms will take effect at the time they are updated.
      Your continued use of this site, even after the posting of changes to
      the Terms and Conditions, will mean you accept those changes. Please
      return to this page periodically to review any changes.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">DEFINITIONS.-</span> For all purposes
      of the Terms and Conditions set forth herein, the following definitions
      shall apply:
      <span class="m-b text-[.938rem]">TRAVEL AGENCY.-</span>
      ...
      <span class="m-b text-[.875rem]">Royal Vacations México</span>”
      indistinctly). www.royalvacationsmexico.com.- Website of
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      ...
      <span class="m-b text-[.875rem]"> “Site”</span>).
      <span class="m-b text-[.938rem]">USER-TOURIST.-</span>
      Person who travels temporarily and/or uses the site
      www.royalvacationsmexico.com, with the purpose of making use of the
      intermediation and the reservation engine of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> and with
      the ultimate purpose of enjoying any of the tourist services provided
      directly by the Supplier (hereinafter referred to as
      <span class="m-b text-[.875rem]"> “You”</span>).
      <span class="m-b text-[.938rem]"> SUPPLIER.-</span> Individual or
      ...
      intermediation and booking engine of the Royal Vacations México website.
    </div>

    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      <span class="m-b text-[.938rem]">DECLARATIONS.-</span> You declare
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> to act
      as a mere intermediary between you and the direct suppliers of tourist
      services.
    </div>
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      You declare under oath that you recognize that the services provided by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> y and
      its Site consist
      <span class="m-b text-[.938rem]">
      ...
      <span class="m-b text-[.938rem]"> VBA180925981</span>. (c) That its
      ...
      <span class="m-b text-[.875rem]">intermediary </span>between tourists
      and providers of transportation services of any kind; to reserve rooms
      and other related services for tourists in hotels and lodging
      establishments; to provide tourists with reservation services for
      tourist attractions; to serve as an
      <span class="m-b text-[.875rem]"> intermediary</span> between other
      ...
      <span class="m-b text-[.875rem]">INTERMEDIARY</span> between You and the
      Providers of such tourist services, and that for such purpose, it has
      the technical and administrative capacity, as well as the material and
      human elements necessary to reserve on Your behalf and at Your request
      the services referred to in these Terms and Conditions. (f) That based
      on the foregoing Declarations, it accepts these Terms and Conditions.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">OBJECT.-</span> The object consists
      of the
      <span class="m-b text-[.875rem]"> INTERMEDIATION</span> that will exist
      between
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, You and
      the Suppliers, where
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      for the purposes of these Terms and Conditions, will act solely and
      exclusively as an
      <span class="m-b text-[.875rem]"> INTERMEDIARY</span>, providing to You
      through its Site, including but not limited to, the reservation service
      of land and air transportation; reservation in hotels and lodging
      establishments; reservation of tourist attraction sites; reservation of
      travel packages; among others; reservation of tourist attraction sites;
      reservation of travel packages; among others. Thus, once the
      reservations are confirmed by
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      containing the tourist services chosen by You (according to
      availability), the provision of the intermediary service by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, will be
      concluded, since such tourist services will be provided to You directly
      by the Suppliers.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">USE OF SITE -</span>
      <span class="m-b text-[.875rem]">Royal Vacations México</span> grants
      you a limited, non-transferable, revocable license to use this Site in
      accordance with these Terms and Conditions. You may use this site only
      to make or purchase legitimate reservations and may not use it for any
      other purpose, including but not limited to making any speculative,
      false or fraudulent reservations. This Site and the content referred to
      herein, including but not limited to: text, paragraphs, sentences,
      specific combination of words, letters or phonetic elements, graphics,
      button icons, trademarks, logos, graphic design works, photographs,
      trade dress, patents, business method, specific combination of colors
      and shapes, editorial material, printed formats, search formats, digital
      downloads, data compilations, source codes, software, etc., are the
      exclusive property of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> or have
      all the Licenses and Authorizations for such use, therefore You may not
      copy, reproduce, republish, upload, upload, modify, transmit or
      distribute such content without the prior written authorization of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, except,
      in the cases (a) in which you download to view and print the material
      contained in this Site or (b) download or print the material that is
      sent to your email by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, in both
      situations you may only and exclusively use it for your personal use,
      and the printed material must always include the legend “© VIAJES BAMO
      S.A. DE C.V. 2018-2020 All rights reserved." Any reproduction of all or
      part of the Site or any use of its contents for commercial gain is
      strictly prohibited.You may not use any "robotic," "spider" or other
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> from
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>or the
      owner of such rights, (c) contains a virus, bug or other dangerous item,
      or (d) is used to unlawfully conspire against another person to the
      detriment of their right to trade or compete. You shall be solely liable
      for any damages for any infringement of copyright, industrial property,
      or any other proprietary rights, or for any other harm caused by your
      misuse of this site.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">AGE AND LIABILITY.-</span>
    ...
    <h2 class="m-b text-[.938rem] pb-[0.5rem]">
      RESERVATION, PAYMENT AND CANCELLATION POLICIES
    </h2>
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      <span class="m-b text-[.938rem]">RESERVATION POLICIES.-</span>
      ...
      and accept these
      <span class="m-b text-[.875rem]"> Terms and Conditions</span>, as well
      as the
      <span class="m-b text-[.875rem]"> privacy policy</span> of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>. All
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> requests
      a maximum of 24 hours for such availability verification and
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.875rem]">Royal Vacations México</span> suggests
      that you carefully read the CANCELLATION POLICY clause. Any reservation
      change is subject to availability and rate re-quotes. For more
      information, you should contact your assigned Travel Consultant,
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      <span class="m-b text-[.938rem]">PAYMENT POLICIES.-</span> The amount
      ...
      <span class="m-b text-[.875rem]"> “Royal Vacations México”</span> or
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> is not
      responsible for such fluctuation. You acknowledge that you have been
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      service provider,
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> assumes
      no responsibility for such charges, nor are they part of the final price
      of your reservation.
    </div>

    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      <a class="text-[14px] py-[7px] m-m no-underline cursor-pointer" href="https://royalvacationsmexico.com/policy">
        <span class="m-b text-[.938rem] text-bl-100 hover:text-or-100">CANCELLATION POLICY.-</span>
      </a>
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico's </span>
      general cancellation policies applicable to most hotels:
    </div>

    <ul class="pl-[2rem] mb-[0.5rem] list-disc">
      <li class="m-m text-[.875rem] pl-[0.5rem] pb-[5px]">
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México:</span> Since
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> from any
      liability or failure to perform, not reserving any administrative, civil
      or criminal action, or any right against
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, or to
      claim any claim, compensation, reimbursement, compensation and / or
      payment of damages.
    </div>
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      Bank.
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> reserves
      the right to contract on your behalf, the services referred to in these
      Terms and Conditions precisely in the quality and / or categories
      contracted, as far as carriers, hotels and car rental companies are
      concerned, regardless of the ultimate provider of services, unless
      expressly agreed that these will be provided invariably by a particular
      provider. In case of modification of the direct service provider, this
      will be provided by another of equivalent quality, if you make use of
      the service, it will be understood that you consented to such
      modification and no claim, compensation or refund will be made. Once
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México </span> and you
      agree to abide by and accept the cancellation, issuance and ticketing
      policies of national and international airlines, the airline ticketing
      policies of IATA International and the Reservation and Cancellation
    ...
    <ul class="pl-[2rem] mb-[0.5rem] list-disc">
      ...
      <li class="m-m text-[.875rem] pl-[0.5rem] pb-[5px]">Changes are subject to bus availability</li>
      <li class="m-m text-[.875rem] pl-[0.5rem] pb-[5px]">
        No changes for discounted tickets (i.e. student, teacher).
      </li>
    </ul>

    <div class="py-[2.5rem] text-justify m-m text-[.875rem]">
      <span class="m-b text-[.938rem]">INDUSTRIAL PROPERTY.-</span>
      You acknowledge that the trademark
      <span class="m-b text-[.875rem]"> “Royal Vacations México”</span>, es is
      a registered trademark or is in the process of being registered for the
      exclusive use of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>.And by
      way of example but not limited to other trademarks, logos, trade names,
      patents, utility models and business methods, customer portfolio, which
      appear or operate on this Site, constitute industrial property rights
      that are registered or in the process of registration, are the exclusive
      property of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, of its
      affiliates, or third party contractors, and were provided for the use of
      the Site, therefore
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      ...
      in the cases (a) in which you download to view and print the material
      contained in this Site or (b) download or print the material that is
      sent to your e-mail by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, in
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>,or if
      applicable, of the holders of such rights. And you are prohibited from
      using them in any other application not permitted by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> or any
      other commercial use. You agree not to alter the Industrial Property of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> in any
      way, nor will you be allowed to act in any way that may impair,
      denigrate or diminish the Industrial Property rights of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>. You
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">COPYRIGHT.-</span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>or the
      supplier that provides the service, with ownership of patrimonial
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, except,
      in the cases (a) e in which You download to view and print the material
      contained in this Site or (b) download or print the material that is
      sent to Your e-mail by
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>, in
      which situations, You may only and exclusively use it for Your personal
      ...
      written consent of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>.And you
      are prohibited from using them in any application not permitted by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> or any
      other commercial use. You agree not to alter
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico's </span>
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">PRIVACY AND SECURITY.-</span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> and/or
      its third party suppliers and distributors in accordance with the terms
      of
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico's </span>
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">REVIEW OF TRANSMISSIONS.-</span>
      <span class="m-b text-[.875rem]">Royal Vacations México </span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, a
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations México </span> is not
      responsible and shall have no liability for any content that is posted
      or submitted by you.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">LIMITATION OF LIABILITY.-</span>
      <span class="m-b text-[.875rem]">Royal Vacations México </span> SHALL
      NOT BE RESPONSIBLE OR ASSUME ANY LIABILITY FOR ANY DAMAGE OR VIRUSES
      THAT MAY INFECT YOUR COMPUTER OR ANY OTHER PROPERTY OF YOURS DUE TO YOUR
      ACCESS, USE OR BROWSING OF THIS SITE, OR YOUR DOWNLOADING OF ANY
      ...
      THAT
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> IS ONLY
      AN INTERMEDIARY IN THE PROVISION OF THE TOURIST SERVICES OFFERED ON THE
      SITE AND UNDERSTANDS THAT IN MOST CASES IT CANNOT CONTROL THE
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">LIABILITY.-</span> You shall be
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">LINKS .-</span> This Site contains
      links to other Web sites which are provided solely for your convenience
      and not as an endorsement by
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> and they
      belong to third party providers or distributors of the contents of such
      other Web sites.
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> shall
      not be responsible for the content of any other Web site and makes no
      representations or warranties about any other Web site or the content or
      material on such other Web sites. If you decide to access other Web
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      pages with user name: Royal Vacations Mexico twitter page with user
      name:
      <span class="m-b text-[.875rem]"> Royal Vacations México </span>
      page on twitter con name de user: @RoyalVacationsMexico y Youtube
      with user Royal
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>,
      ...
      social diffusion of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>, and
      <span class="m-b text-[.875rem]"> Royal Vacations México</span> will not
      be responsible for the content, information, third party publications,
      comments, photographs, videos, hashtags content, or any other material
      outside the scope of the direct administration of
      <span class="m-b text-[.875rem]"> Royal Vacations México</span>,nor for
      the material shared on such social sites by you or any third party and
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">CLIMATE.-</span> This site le
      ...
      demarcate a
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> and
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> No will
      be responsible on any inconsistency, inaccuracy or Information published
      within your weather service,
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span>No is
      responsible for any change in conditions climatic, being outside the
      absolute control of
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>,
      Therefore you recognize and release from all responsibility to
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> of
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      Maps ©, so you release
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> of any
      responsibility derived from any inconsistency Regarding the location or
      addresses shown on the maps, it releases
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> on any
      disorientation, or any loss of location that could suffer from the use
      of maps and release
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> of more
      non -limiting enunciative way about any change, Refund, complaint,
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">TRUE INFORMATION.-</span> You
      ...
      releasing
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span> of any
      responsibility for itinerary changes generated by poorly provided data,
      or for any data error provided by you for the issuance or purchase of
      aerial tickets as can be the case of ages, sex, names, surnames, dates,
      payment methods, routes, airlines, schedules, classes, categories,
      special conditions, etc., in your case to the clauses of Cancellation
      for air, land, maritime or cruise services Expressed in these Terms and
      Conditions.
    </div>
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>, hence
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> You must
      make your knowledge the most important, not However, the supplier may
      make your knowledge new or additional service conditions on which
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> No It
      has any responsibility and consequently declines any responsibility that
      could derive for its breach.In addition, You must by your own means of
      passports or Migration documents required by the authorities of the
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> by be of
      exclusive responsibility of you.In travel cases International you
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> y/o some
      other instruction to present even before these Authorities.
    </div>
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      <span class="m-b text-[.875rem]">Royal Vacations Mexico</span> It is
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> to
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> by
      account of diverse travel agency, or any third, funding these as
      intermediaries,
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span>HE
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      <span class="m-b text-[.875rem]">Royal Vacations Mexico</span> As an
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> is to
      serve solely and exclusively as INTERMEDIARY and not as Direct provider
      of tourist services,
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span>No
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> on any
      responsibility for any failure or lack of compliance by the supplier or
      direct suppliers of the tourist services, including any failure without
      limitation or compliance by airlines, hotels, suppliers of temporary
      lodging, shipping companies and all kinds of boats, Aquatic sports
      suppliers, car rental agencies, Transportation agencies, Tours
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>; However
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>, You may
      to your free discretion provide contact data and/or Address of the
      provider so that you exercise the claim respective or claim that you
      consider necessary.
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> As a
      ...
      <span class="m-b text-[.875rem]">
        ...
        Royal Vacations Mexico. Royal Vacations Mexico
      </span>
      , It does not assume responsibility before you and you release all
      Responsibility a
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> by acts,
      omissions or any type of complaint or dissatisfaction of the services
      provided by the direct suppliers of Services on the site announced, by
      virtue of
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> No It
      has any legal control over your staff, equipment, operation, advertising
      or goods.In those situations in which the Supplier fails in providing
      your services you can try any resource allowed by applicable laws
      against Supplier.
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> you
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      Royal Vacations Mexico also will not be responsible and you release All
      responsibility a
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> in
      respect of:
    </div>
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      services.
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> No will
      assume any responsibility and you release all responsibility to
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>, as well
      as any claim, cost, expense or loss that you could suffer including any
      personal wound or third parties, accidents or death, damage to personal
      belongings, loss of fun, anger, disappointment, anguish or frustration,
      either mental or Physics, provided they are the result of:
    </div>
    ...
    <ul class="pl-[2rem] mb-[0.5rem] list-disc">
      ...
      <li class="m-m text-[.875rem] pl-[0.5rem] pb-[5px]">
        ...
        <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>. Any
        claim or written notification against
        <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>, must
        be received no later than fourteen (14) days after Return of your
        trip;
        <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span>
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>, HE can
      retain 10% of the total amount paid by the reservation as administrative
      expenditure.Despite the narrow communication established by
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span>
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico </span> The
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> and its
      suppliers of any responsibility or compensation payment for
      ...
      relieved
      <span class="m-b text-[.875rem]"> Royal Vacations</span> Mexico of any
      greater responsibility or commitment in cases where the reimbursement
      for the total or remaining amount is not reimbursed by the Supplier.
    </div>
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      In cases that by any error or manipulation by you of the system of
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> an
      ...
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span> You can
      notify the tourist client the real and true price before the provision
      of the service, so that the client decides if he wishes keep your
      reservation and if not, accept that amounts you have paid, be reimbursed
      in the same method of payment you have made, without responsibility for
      <span class="m-b text-[.875rem]"> Royal Vacations Mexico</span>.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">Off "U.S. Citizens"/Cuba.-</span>
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">TERMINATION .- </span> Royal
      Vacations Mexico can terminate these term and conditions and/or any of
      ...
      obligation contracted by Royal Vacations Mexico before you once a
      reservation is confirmed.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">TERMINATION.-</span> You will not be able
      to yield, subcontract, or delegate your rights, obligations or duties
      here contracted.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">DIVISIBILITY.-</span> These Terms and
      Conditions will continue to be divisible.If any term or condition is
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">TITLES.-</span> The titles Used in
      the Terms and Conditions are only used for their convenience and will not
      limit or affect otherwise the content of The term and conditions
      established here.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">TOTAL AGREEMENT.-</span> The present
      the term and conditions, which are included here, or to which Reference
      is made, they constitute the total and complete agreement between the
      Parties in relation to the object established here, and replaces any
      previous agreement or contract made between the parties (already be oral
      or written) that is related to the same object, and not It will be
      amended or modified except whether it is done in writing or doing That
      such amendments or modifications are available on this site.
    </div>

    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      <span class="m-b text-[.938rem]">APPLICABLE LEGISLATION.-</span>
    ...
    <div class="pb-[0.5rem] m-m text-[.875rem] text-justify">
      ...
      When booking with
      <span class="m-b text-[.875rem]">Royal Vacations Mexico</span>, You read
      our term and conditions carefully and you are agreement that
      <span class="m-b text-[.875rem]">Royal Vacations Mexico</span>
    ...
    <div class="m-m text-[.875rem] text-justify pb-[2.5rem]">
      ...
      <span class="m-b text-[.875rem]">Royal Vacations Mexico</span>No assumes
      responsibility for the efficiency of these protocols.
    </div>
  </div>
  );
}
