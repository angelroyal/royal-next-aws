...
import EmptyItinerary from "./Alerts/EmptyItinerary";
import DetailsPayment from "./others/DetailsPayment";
  ...
  return (
    <>
      <div className="w-full h-full relative bg-[#f6f6f6]">
        ...
        {data && data.items && (
          <DialogPaymentItinerary reservationData={data} />
        )}
      </div>
