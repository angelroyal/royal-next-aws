...
import { ReactComponent as Tour } from "../../assets/images/others/tour.svg";
import { ReactComponent as Hotel } from "../../assets/images/others/hotel.svg";
import { ReactComponent as Transfer } from "../../assets/images/others/transfer.svg";
  ...
  return (
    <Row className="width100 m-0">
      <Col sm={4} className="service-hotel-tour-transportation">
        <Hotel i className="service-quality" />
      ...
      <Col sm={4} className="service-hotel-tour-transportation">
        <Transfer className="service-quality" />
        <div className="styles-name-icon-service">
          <div className="name-icon-service">
      ...
      <Col sm={4} className="service-hotel-tour-transportation">
        <Tour className="service-quality" />
        <div className="styles-name-icon-service">
          <div className="name-icon-service">
